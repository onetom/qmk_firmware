...
#define my_d MT(MOD_LALT, KC_D)
#define my_f MT(MOD_LALT, KC_F)

#define my_j MT(MOD_RALT, KC_J)
#define my_k MT(MOD_RALT, KC_K)
...
[_QWERTY] = LAYOUT( \
  ...
  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, \
      ALT_T(KC_TAB), LT(_LOWER, KC_BSPC), GUI_T(KC_SPC),     GUI_T(KC_ENT), LT(_RAISE, KC_DEL), KC_LCTL  \
),
